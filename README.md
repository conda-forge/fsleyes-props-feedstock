...
Development: https://git.fmrib.ox.ac.uk/fsl/fsleyes/props/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3891&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fsleyes-props-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fsleyes-props` can be installed with `conda`:
...
```
mamba install fsleyes-props
```

It is possible to list all of the versions of `fsleyes-props` available on your platform with `conda`:
...
```
mamba search fsleyes-props --channel conda-forge
```
...
mamba repoquery search fsleyes-props --channel conda-forge

# List packages depending on `fsleyes-props`:
mamba repoquery whoneeds fsleyes-props --channel conda-forge

# List dependencies of `fsleyes-props`:
mamba repoquery depends fsleyes-props --channel conda-forge
```
